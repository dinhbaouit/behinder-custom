...
public class Run {
    ...
    public static byte[] getClassFromSourceCode(String sourceCode) throws Exception {
        ...
        if (jc == null) {
            throw new Exception("The compilation environment was not found on the local machine, please confirm: 1. Whether the JDK environment is installed; 2." + System.getProperty("java.home") + File.separator + "Whether there are tools in the lib directory .jar.");
        }
